...
#define PERIPH_BOTTOM                                         0x3F000000
#define PERIPH_LIMIT                                          0x40400000

//#define SUBSYSTEM_BASE                                        0x20000000  //PI1
#define SUBSYSTEM_BASE                                        0x3F000000  //PI2

#define ARM_TIMER_CTL                                         (SUBSYSTEM_BASE + 0xB408)
#define ARM_TIMER_CNT                                         (SUBSYSTEM_BASE + 0xB420)
...
#define INT_BASE                                              (SUBSYSTEM_BASE + 0x0000B000)
#define IRQ_BASIC_PEND                                        (INT_BASE + 0x200)
#define IRQ_PEND1                                             (INT_BASE + 0x204)
#define IRQ_PEND2                                             (INT_BASE + 0x208)
#define FIQ_CNTL                                              (INT_BASE + 0x20C)
#define ENABLE_IRQ1                                           (INT_BASE + 0x210)
#define ENABLE_IRQ2                                           (INT_BASE + 0x214)
#define ENABLE_BASIC_IRQ                                      (INT_BASE + 0x218)
#define DISABLE_IRQ1                                          (INT_BASE + 0x21C)
#define DISABLE_IRQ2                                          (INT_BASE + 0x220)
#define DISABLE_BASIC_IRQ                                     (INT_BASE + 0x224)
